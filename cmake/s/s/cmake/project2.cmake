...
set(target_root ${PROJECT_SOURCE_DIR}/src)
...
if(NOT target_default_include)
	set(target_default_include ${PROJECT_SOURCE_DIR} ${PROJECT_SOURCE_DIR}/include ${target_root}/include)
...
function(add_target)
	set(_options)
	set(_oneValueArgs name version epport_name)
	...
	if(_target_auto_sources AND EXISTS ${target_root}/${_target_name})
		file(GLOB_RECURSE _s ${target_root}/${_target_name}/*.c*) # c cc cpp cxx
		if(_target_auto_sources_dir)
			...
			foreach(_rd ${_remove_dirname})
				if(EXISTS ${target_root}/${_target_name}/${_rd})
					file(GLOB _ss ${target_root}/${_target_name}/${_rd}/*.c*)
					if(_ss)
	...
	if(_target_auto_include)
		...
		if(EXISTS ${target_root}/${_target_name})
			list(APPEND _target_include2 PRIVATE ${target_root}/${_target_name})
		endif()
	...
	if(_target_version OR _target_auto_version)
		if(NOT _target_version)
			set(_f ${target_root}/${_target_name}/version) # VERSION
