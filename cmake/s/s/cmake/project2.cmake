...
function(add_target)
	...
	set(_multiValueArgs depends sources include options link properties files install definitions ignore public_header hidden conditions conditions_var arg on off)
...
macro(target_config_file)
	...
	# file(REMOVE ${_out_f})
endmacro()
macro(target_fix_win_dll)
	if(WIN32 AND target_all_exports)
		foreach(_t IN LISTS target_all_exports)
			list(APPEND _d PRIVATE ${_t}_shared_EXPORTS)
		endforeach()
		foreach(_t IN LISTS target_object_targets)
			target_compile_definitions(${_t} ${_d})
		endforeach()
	endif()
	unset(_t)
	unset(_d)
